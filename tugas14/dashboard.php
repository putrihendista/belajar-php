...
?>
  ...
  <div class="content-wrapper">
    ...
    $query_produk = "SELECT COUNT(*) as jumlah_produk FROM products";
    $result_produk = mysqli_query($conn, $query_produk);
    $row_produk = mysqli_fetch_assoc($result_produk);
    $jumlah_produk = $row_produk['jumlah_produk'];
    
    // Query untuk mengambil jumlah pelanggan
    $query_pelanggan = "SELECT COUNT(*) as jumlah_pelanggan FROM customers";
    ...
    // Query untuk mengambil jumlah vendor
    $query_vendor = "SELECT COUNT(*) as jumlah_vendor FROM vendors";
    $result_vendor = mysqli_query($conn, $query_vendor);
    $row_vendor = mysqli_fetch_assoc($result_vendor);
    $jumlah_vendor = $row_vendor['jumlah_vendor'];
